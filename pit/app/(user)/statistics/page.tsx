...
🤦 Total Mistakes --
      ...
      <div className="stat-blocks">
        <div className="stat-block">
          ...
          <div className="stat-value" id="cars-on-fire">11</div>
        </div>
        <div className="stat-block">
          <div className="stat-icon">🛞</div>
          <div className="stat-title">Wheels Lost</div>
          <div className="stat-value" id="wheels-lost">5</div>
        </div>
        <div className="stat-block">
          <div className="stat-icon">🚩</div>
          <div className="stat-title">Race Ruined</div>
          <div className="stat-value" id="race-ruined">3</div>
        </div>
      </div>
    </section>
...
👑 Longest Perfect Combo --
      ...
      <div className="stat-blocks">
        <div className="stat-block">
          ...
          <div className="stat-value" id="fastest-refuel">0.560s</div>
        </div>
        <div className="stat-block">
          <div className="stat-icon">🛞</div>
          <div className="stat-title">Fastest Tire Change Ever</div>
          <div className="stat-value" id="fastest-tire-change">0.630s</div>
        </div>
        <div className="stat-block">
          <div className="stat-icon">🔧</div>
          <div className="stat-title">Fastest Complete Pit Stop</div>
          <div className="stat-value" id="fastest-pitstop">0.950s</div>
        </div>
      </div>
    </section>
