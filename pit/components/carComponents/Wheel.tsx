...
export default function Wheel({
  ...
  function Bolt({
    ...
    index,
    setBolt
  }: { bolt_length?: number, index: number, setBolt: (index: number, setTo: boolean)=>void } & ItemProps) {
...
function NormalWheel({setBolt} : {setBolt: (index: number, setTo: boolean)=>void}){
  return (
    <div
