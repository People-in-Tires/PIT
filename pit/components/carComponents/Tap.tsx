...
function Faucet({flowrate = 1000}: {flowrate: number}){
	...
	return <div style={{height: "200px", width: "100px", left: "50px", position: "absolute"}}>
		<button style={{height: "30px", width: "100px", position: "absolute"}} onMouseDown={()=>setPressed(true)} onMouseUp={()=>setPressed(false)} onMouseLeave={()=>setPressed(false)}>
			<img src={"/beer.png"}></img>
		</button>
		<div ref={tapref} className="tap" style={{top:"100px", height: "100px", width: "100px"}}>
			<img src={"/bin.png"}></img>
		</div>
	</div> 
}
...
export default function Tap(){
	return <div className={styles.item} style={{top: "500px", left: "500px"}}>
