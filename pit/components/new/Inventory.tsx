...
import { registerDropHandler, unregisterDropHandler, toLocalCoords } from "@/shared/dropRegistry";
...
export default function Inventory() {
  ...
  useEffect(() => {
    registerDropHandler("inventory", ({ id, clientX, clientY, containerEl }) => {
      ...
      const { x, y } = toLocalCoords(containerEl, targetRect.left, targetRect.top);
